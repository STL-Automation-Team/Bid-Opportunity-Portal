...
export default function EditOperation() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axios.put(`http://localhost:8080/v1/operations/${Id}`, req);
      handleShowModal();
    } catch (error) {
      console.error(error);
    }
  ...
  const loadOperation = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/v1/operations/${Id}`);
      ...
      >
        ...
        >
          ...
          <FormFields2
            ...
            type="select"
            defaultValue={operation.status.id}
            register={register}
            errors={errors}
            trigger={trigger}
            setValue={setValue}
          ...
          <FormFields2
            ...
            name="operationType"
            type="select"
            defaultValue={operation.type.id}
            register={register}
            errors={errors}
            trigger={trigger}
            setValue={setValue}
          ...
          <FormFields2
            ...
            name="reporter"
            type="select"
            defaultValue={operation.reporter.id}
            register={register}
            errors={errors}
            trigger={trigger}
            setValue={setValue}
          ...
          <FormFields2
            ...
            name="assignee"
            type="select"
            defaultValue={operation.assignee.id}
            register={register}
            errors={errors}
            trigger={trigger}
            setValue={setValue}
          ...
          <FormFields2
            label="Ticket"
            name="ticket"
            defaultValue={operation.ticketId}
            register={register}
            errors={errors}
            trigger={trigger}
          />
          <FormFields2
            ...
            name="asset"
            type="select"
            defaultValue={operation.asset.id}
            register={register}
            errors={errors}
            trigger={trigger}
            setValue={setValue}
