...
const OpportunityDetails = () => {
  ...
  const fetchSubmittedData_deal_status = (id, deal_status, additional_remarks_) => {
    const updateData = {
        ...opportunity,
  ...
  const handleFormSubmission2 = (deal_status, additional_remarks_) => {
    fetchSubmittedData_deal_status(opportunity.id, deal_status, additional_remarks_); // Refresh submitted data after form submission
    setActiveForm(null);
  };
    ...
    <div className='main1'>
      ...
      <div className="follow-ups-header">
        ...
        <DealStatusUpdateForm show={activeForm === 'DealStatusUpdate'}
            ...
            form_id={opportunity.id}
         />
        {submittedData.length === 0 && submittedData1.length === 0 && submittedData2.length === 0 && (
