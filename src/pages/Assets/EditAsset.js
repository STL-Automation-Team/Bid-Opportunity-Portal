...
export default function EditAsset() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await axios.put(`http://localhost:8080/v1/assets/${Id}`, requestData, {
        params,
      });
      console.log(requestData);
      handleShowModal();
  ...
  const loadAsset = async () => {
    try {
      const response = await axios.get(`http://localhost:8080/v1/assets/${Id}`);
      console.log(response.data);
      ...
      <div style={{ width: "100%", padding: "1rem 2rem" }}>
                ...
                <div className="row mb-3 ">
                  ...
                  >
                    ...
                    <input
                      ...
                      name="requireSupport"
                      defaultValue={asset.requireSupport}
                ...
                <div className="row mb-3">
                  ...
                  <div className="col-sm-8 ">
                    <input
                      ...
                      defaultValue={asset.depreciationRate}
                ...
                <div className="row mb-3">
                  ...
                  >
                    <input
                      ...
                      defaultValue={asset.forceDepreciation}
                  ...
                  <div className="row mb-3">
                    ...
                    <div className="col-sm-8 ">
                      <input
                        ...
                        defaultValue={asset.customFieldValues[customField.id]}
                        {...console.log(
                          "*****",
                          customField.name,
                          asset.customFieldValues[customField.id],
                          show
                        )}
        ...
        <Modal show={showModal} onHide={handleCloseModal}>
          ...
          <Modal.Body className="modal-style">
            <p>Your asset has been successfully Edited.</p>
          </Modal.Body>
